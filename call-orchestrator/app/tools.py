"""
The 5 tools Claude (via Bedrock converse + toolConfig) can invoke during
an outbound call. TOOL_CONFIG is passed straight into the converse()
call; execute_tool() runs the matching Python side effect.

Restored from the pre-LiveKit T-12 version — unchanged, since this part
of the architecture (raw Bedrock converse loop) is provider-agnostic and
doesn't care whether the call transport is Twilio or Vonage.
"""
import logging
